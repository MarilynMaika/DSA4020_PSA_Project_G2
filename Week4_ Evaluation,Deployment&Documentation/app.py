...
# ---------------------------------------------------------------------------
MT5_AVAILABLE = os.path.isdir(MT5_MODEL_DIR)
NLLB_AVAILABLE = os.path.isdir(NLLB_MODEL_DIR)
...
def _seq_confidence(model, out):
    ...
    Same method used in the training notebooks' section 4.5, so numbers are comparable."""
