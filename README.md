...
- **EDA:** domain distribution, text length distributions, vocabulary size, and language-pair statistics across the full 21,306-row dataset (see table above).
  ...
  <h3 align="center">PSA Distribution Across Domains</h3>

<p align="center">
  <img src="Screen_shoots/Distribution_across_domains.png" 
       alt="PSA Distribution Across Domains"
       width="700">
</p>

<p align="center">
  <em>Figure: Distribution of Public Service Announcements across the dataset domains.</em>
</p>
