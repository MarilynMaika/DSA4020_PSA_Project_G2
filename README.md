...
- **70,000 rows**, columns: `PSA_ID, Domain, English`
...
- Translate the synthetic English PSAs into Kiswahili, Ekegusii, Somali, and Dholuo.
- Reconcile the merged-scrape schema (11 columns) and synthetic-dataset schema (3 columns) into one final parallel-corpus schema.
